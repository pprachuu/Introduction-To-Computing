...
print("The problem of tower of Hanoi with three disks is solved as follows: ")
...
for i in range (4,7):
    thislist.append(i)
print(f"Adding (4,5,6) in the values ({c},{d})")
newlist=[]
...
#getting input from the first friend
word = input("Enter the first word: ")
print("\n")
#getting input for a meaningful word with the exact same letters
...
if count_in_dict(word) != count_in_dict(testword):
    ...
    #function for the shopkeeper, to check if the word makes sense or not
    def userinput():
